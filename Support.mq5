...
enum iTrend {Auto=0, Buy=1, Sell=2};
...
double SARValue;
double ActiveTask[50];
double Ask, Bid, AskQuery, BidQuery, Price;
string singal = "N/A";
...
void OnTick()
  {
   ...
   Price = NormalizeDouble(SymbolInfoDouble(_Symbol,SYMBOL_LAST),_Digits);
