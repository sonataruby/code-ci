	...
	<div class="col-lg-9 col-sm-12">
		...
		<div class="row">
			<div class="col-lg-3 col-sm-12">
				<div class="hbox border tools_desktop" style="min-height: 70vh;">
...
<?php addon("addon/editer",["target" => "#textarea", "form" => "#savedata", "tools" => "true", "libs" => "default", "tools_desktop" => ".tools_desktop"]);?>
