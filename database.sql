...
INSERT INTO `posts` (`post_id`, `post_title`, `post_image`, `post_url`, `post_content`, `post_tag`, `created_date`, `updated_date`, `language`, `status`, `views`) VALUES
...
(14, 'plugins', '{\"home\\/slider\":\"Slider\",\"pages\\/pages\":\"Pages\",\"posts\\/catalog\":\"Catalog\",\"posts\\/posts\":\"Posts\"}', 'english', 'localhost', '0000-00-00 00:00:00'),
...
--
ALTER TABLE `posts_incatalog`
  MODIFY `incat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `settings`
  MODIFY `config_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;