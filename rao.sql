...
--
-- Host: localhost:3306
-- Generation Time: Oct 17, 2019 at 09:53 AM
...
INSERT INTO `accounts` (`account_id`, `network_id`, `account_email`, `account_password`, `account_type`, `status`, `is_banned`, `banned_reson`, `created_date`) VALUES
...
INSERT INTO `accounts_info` (`account_id`, `avatar`, `firstname`, `lastname`, `address`, `address2`, `country`, `region`, `city`, `zipcode`, `phone`, `tel`, `updated_date`) VALUES
