<?php libs_url("builder/css/editor.css");?>
<?php libs_url("builder/css/line-awesome.css");?>
...
<style type="text/css">
	...
	#vvveb-builder #right-panel, #vvveb-builder #top-panel, #vvveb-builder #left-panel, #vvveb-builder #canvas{
		top: auto;
	}
...
<div class="modal fade" id="message-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <p class="modal-title text-primary"><i class="la la-lg la-comment"></i> Create Page</p>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><small><i class="la la-close"></i></small></span>
        </button>
      </div>
...
<!-- jquery-->
<?php libs_url("builder/js/jquery.hotkeys.js");?>
<?php libs_url("builder/libs/builder/builder.js");?>
<?php libs_url("builder/libs/builder/undo.js");?>
<?php libs_url("builder/libs/builder/inputs.js");?>
<?php libs_url("builder/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js");?>
<?php libs_url("builder/libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css");?>
<?php libs_url("builder/libs/builder/plugin-bootstrap-colorpicker.js");?>


<?php libs_url("builder/libs/builder/components-server.js");?>
<?php libs_url("builder/libs/builder/components-bootstrap4.js");?>
<?php libs_url("builder/libs/builder/components-widgets.js");?>
<?php libs_url("builder/libs/builder/blocks-bootstrap4.js");?>

<?php libs_url("builder/libs/codemirror/lib/codemirror.css");?>
<?php libs_url("builder/libs/codemirror/theme/material.css");?>
<?php libs_url("builder/libs/codemirror/lib/codemirror.js");?>

<?php libs_url("builder/libs/codemirror/lib/xml.js");?>
<?php libs_url("builder/libs/codemirror/lib/formatting.js");?>
<?php libs_url("builder/libs/builder/plugin-codemirror.js");?>
<?php libs_url("builder/libs/builder/plugin-animate.js");?>
<?php libs_url("builder/libs/autocomplete/jquery.autocomplete.js");?>
...
$(document).ready(function() 
{
	...
	Vvveb.Builder.init('/libs/builder/demo/narrow-jumbotron/index.html', function() {
	...
	[
		{name:"narrow-jumbotron", title:"Jumbotron",  url: "/libs/builder/demo/narrow-jumbotron/index.html", assets: ['/libs/builder/demo/narrow-jumbotron/narrow-jumbotron.css']},
		{name:"landing-page", title:"Landing page",  url: "/libs/builder/demo/startbootstrap-landing-page/index.html", assets: ['/libs/builder/demo/startbootstrap-landing-page/css/landing-page.min.css']},
