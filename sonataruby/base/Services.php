 ...
 * @version         3.0.0
 */
abstract class Services extends \CI_Controller{
    ...
    protected $http_status_codes = [
        ...
        Definitions::HTTP_CREATED => 'CREATED',
        Definitions::HTTP_NO_CONTENT => 'NO CONTENT',
        Definitions::HTTP_NOT_MODIFIED => 'NOT MODIFIED',
        Definitions::HTTP_BAD_REQUEST => 'BAD REQUEST',
        Definitions::HTTP_UNAUTHORIZED => 'UNAUTHORIZED',
        ...
        Definitions::HTTP_CONFLICT => 'CONFLICT',
        Definitions::HTTP_INTERNAL_SERVER_ERROR => 'INTERNAL SERVER ERROR',
        Definitions::HTTP_NOT_IMPLEMENTED => 'NOT IMPLEMENTED'
    ];
    ...
    public function __construct($config = 'rest')
    {
        ...
        $this->lang->load('service_api', $language, FALSE, TRUE);
        //print_r($this->lang);
        ...
        if ($this->input->is_ajax_request() === FALSE && $this->config->item('rest_ajax_only'))
        {
            ...
            ], Definitions::HTTP_NOT_ACCEPTABLE);
        }
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        if (! method_exists($this, $controller_method))
        {
            ...
            ], Definitions::HTTP_METHOD_NOT_ALLOWED);
        }
        ...
        if ($this->config->item('rest_enable_keys') && empty($this->rest->key) === FALSE)
        {
            ...
            if ($this->config->item('rest_enable_limits') && $this->_check_limit($controller_method) === FALSE)
            {
                ...
                $this->response($response, Definitions::HTTP_UNAUTHORIZED);
            }
    ...
    public function response($data = NULL, $http_code = NULL, $continue = FALSE)
    {
        ...
        if(!$isProfilingEnabled){
            ...
            {
                $http_code = Definitions::HTTP_NOT_FOUND;
            }
            ...
            $http_code > 0 || $http_code = Definitions::HTTP_OK;
